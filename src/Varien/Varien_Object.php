...
/**
 * NOTE
 * This class as been converter to a trait to make it mockable by the class-mocker
 * the original code is part of Magento (http://www.magento.com)
 */
...
//    }
     ...
     * @param mixed $value
     */
    public function ___set($var, $value)
    {
        $var = $this->_underscore($var);
